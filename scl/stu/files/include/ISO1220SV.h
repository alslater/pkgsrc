...
*        for derived class for the ISO1220SV object. The 1220 message is used
*		 by the client application to transmit information about a financial transaction.
...
/**************************************************************************
 *
 * CLASS NAME:          ISO1220SV
 *
 * SCOPE:               public
 *
 * DESCRIPTION:
 *
 * An ISO1220SV represents the lowest level object that holds the
 * actual message pertaining to the Financial Funding Advice of the ISO8583 message.
 ...
 */
 ...
 class ISO1220SV : public ISO8583Implementation
 {
