...
*
*   Contents:
*       ISO1220SVVal class functions
*
*   Description
*
*        This file contains the implementations of the functions in ISO1220SVVal
 ...
 *
 */
bool ISO1220SVVal::performValidation(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
	bool status = false;
 ...
 *	
 */	
bool ISO1220SVVal::checkRequiredFields(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
	bool status = false;
	//counter variable
	int i=0;
 ...
 *
 */	
bool ISO1220SVVal::checkPAN(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
	//status variable
	bool status = false;
 ...
 *
 */
bool ISO1220SVVal::checkProcessingCode(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
	bool status = false;
 ...
 *
 */
bool ISO1220SVVal::checkTransAmount(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
 ...
 *
 */
bool ISO1220SVVal::checkDate(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
 ...
 *
 */
bool ISO1220SVVal::checkMerchantType(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
 ...
 *
 */
bool ISO1220SVVal::checkCountryCode(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
...
bool ISO1220SVVal::checkPOSData(FieldMapElement *fieldMap[],int mapSize,ISOStatus &statusRef)
{
 ...
 *
 */
bool ISO1220SVVal::checkFunctionCode(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
 ...
 *
 */
bool ISO1220SVVal::checkAcceptorBusinessCode(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
	bool status = false;
	//counter variable
	int i=0;	
 ...
 *
 */
bool ISO1220SVVal::checkSEN(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
 ...
 *
 */
bool ISO1220SVVal::checkTransCurrencyCode(FieldMapElement* fieldMap[],int mapSize,ISOStatus &statusRef)
{
