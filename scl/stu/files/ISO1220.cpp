...
*
*   Contents:
*       Implementation of the ISO1220 class constructor and methods
*       
*   Description
...
#define ISO1220_CLASS_NAME  "ISO1220"

//Definitions for the ISO1220 Constructor and methods
//Default Constructor
ISO1220::ISO1220()
{
}

//Definition of the ISO1220 Constructor

/* Constructor Name: ISO1220
 *  Arguments:
...
ISO1220::ISO1220(int mapSize) : ISO8583Implementation("1220", mapSize)
{
    m_className = ISO1220_CLASS_NAME;
    ...
    //For ISO1220 class, the validation object is ISO1220Validation
    m_validator = new ISO1220Val ();
}


//Definition of the ISO1220 Constructor

/* Destructor Name: ISO1220
...
char *ISO1220::getResponseType ()
{
	return "ISO1230";
}

char *ISO1220::getRequestType ()
{
	return getStaticRequestType ();
}

char *ISO1220::getStaticRequestType ()
{
	return "ISO1220";
}

ISO8583Implementation *ISO1220::Make (char *mName, int mapSize)
{
...
/*
	...
	{
		retval = new ISO1220 (mapSize);
	}
*/

	if (strcmp (mName, ISO1220_CLASS_NAME) == 0)
	{
		retval = new ISO1220 (mapSize);
	}
...
static ISO1220 *exemplar1220SV = 
	(ISO1220 *)ISO8583ClassFactory().addClass (new ISO1220 (64));
