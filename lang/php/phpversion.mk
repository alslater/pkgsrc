...
PHP_VERSIONS_ACCEPTED?=		74 81 83 84
...
.if exists(${LOCALBASE}/lib/php/${PHP84_RELDATE})
_PHP_VERSION_84_INSTALLED=	yes
_PHP_INSTALLED=			yes
.elif exists(${LOCALBASE}/lib/php/${PHP83_RELDATE})
...
PHP_EXTENSION_DIR=	lib/php/${PHP84_RELDATE}
.else
# force an error
